...
module.exports = (Mapa) => {
  ...
  Mapa.geotecnico = (comunidad, observacion, existente, clasificacion, desde, hasta,descripcion, next) => {
    ...
    */
    ...
    var sql = "select *,st_x(st_transform(((ST_SetSRID(ST_Point(x, y),4326))::GEOMETRY),3857)) as x1,"
      +"st_y(st_transform(((ST_SetSRID(ST_Point(x, y),4326))::GEOMETRY),3857)) as y1  from monitoreo.vista_observacion_geotecnico "
    if(comunidad != null){
